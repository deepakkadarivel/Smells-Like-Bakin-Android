...
public class DualPaneFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (savedIngredientsFragment == null) {
            ...
            fragmentManager.beginTransaction().add(R.id.leftPlaceholder, ingredientsFragment).commit();
        }
        ...
        if (savedDirectionsFragment == null) {
            ...
            fragmentManager.beginTransaction().add(R.id.rightPlaceholder, directionsFragment).commit();
        }
